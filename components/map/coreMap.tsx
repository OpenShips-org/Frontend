...
const CoreMap = forwardRef<CoreMapRef, CoreMapConfig>(function CoreMap(
    config,
    ref,
) {
    const {
    ...
    const setMapRef = useCallback((instance: CoreMapRef | null) => {
        innerRef.current = instance
        if (typeof ref === "function") ref(instance)
        else if (ref) (ref as React.RefObject<CoreMapRef | null>).current = instance
